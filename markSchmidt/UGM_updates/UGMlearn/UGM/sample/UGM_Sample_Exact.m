function [samples] = UGM_Sample_Exact(nodePot,edgePot,edgeStruct,infoStruct)
% Exact sampling

assert(prod(infoStruct.nStates) < 50000000,'Brute Force Exact Sampling not recommended for models with > 50 000 000 states');
